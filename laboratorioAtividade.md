...
```
(Fa0/1 = ERP, Fa0/2 = SERVER DNS, Gig0/1 = link pro ROTEADOR-EMPRESA — ajuste as portas conforme os cabos reais. A porta do PC5 continua como estava, `access vlan 10`.)
...
vlan 20
 name RH
! porta do PC de RH (adicione um PC novo no Switch4 pra testar)
